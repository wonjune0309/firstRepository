...
<body>	
	<h1>Broadcast 란?</h1>
	<h3>한 네트워크에 속한 모든 사용자가 소통할 수 있는 1:n 의 통신방식</h3>
	...
	<div id="chatbox" style="display:none;">
		<fieldset style="display:inline-block; width:65%; background:lightgray;">
			...
			<textarea  id="inputMessage" cols="30" rows="4" style="width:50%; resize:none; "></textarea>
	...
	function connection(){
		webSocket = new WebSocket('ws://192.168.20.58:8088<%=request.getContextPath()%>/broadcast');
